...
ThermoFunction(
    Num(parse_expr_to_symbolic(expr, @__MODULE__)),
    params;
    vars=vars,
    ref=ref,
)
...
julia> Cp = ThermoFunction(Cpexpr, [:a₀ => 210.0u"J/K/mol", :a₁ => 0.12u"J/mol/K^2", :a₂ => -3.07e6u"J*K/mol", :a₃ => 0.0u"J/mol/√K"]; ref=[:T => 298.15u"K", :P => 1u"bar"])
